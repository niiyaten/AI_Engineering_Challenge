...
質問: 中間報告会または中間レビューが2025年7月1日以前に実施された案件を、主略称ですべて挙げてください。
...
record_type: pptx_slide
text:
Slide 12 05 実施体制 ─ 発注者・受託者 発注者 会社名 医療法人社団 恒一会 かえで総合病院 部署名 医療情報分析室 主担当者 柴田 海斗 役職 室長 受託者 会社名 株式会社データアステル 部署名 データサイエンス部 ⇄ コミュニケーション運営 週次の進捗共有を実施 中間レビューを第3週目安で実施 最終レビューを最終報告前に実施 課題、前提変更、論点はPMが一元管理 議事録と成果物間の整合性を維持
