...
record_type: generic_chunk
text:
人別処遇判断その他これらに準ずる判断を直接行うためのものではない。 甲は、本業務の成果物を自己の責任において利用するものとし、差別的判断や不利益取扱いへの直接利用を行わないものとする。 乙の損害賠償責任は、乙の故意または重過失による場合を除き、甲が本契約に基づき乙に対して現実に支払った報酬額を上限とする。 乙は、逸失利益、間接損害、特別損害、結果的損害および第三者からの請求に基づく損害について、乙の故意または重過失による場合を除き責任を負わない。 ## 12. 準拠法および裁判管轄 本契約の成立、効力、履行および解釈については、日本法を準拠法とする。 本契約に関して甲乙間に生じた一切の紛争については、東京地方裁判所を第一審の専属的合意管轄裁判所とする。 ## 13. 署名欄 本契約締結の証として、本書を2通作成し、甲乙各1通を保有する。 契約締結日：2025-08-18 効力発生日：2025-08-18 ### 甲 株式会社東都人材プラットフォーム 人事戦略部 人材データ活用室 主担当者：石川 直樹 役職：人事戦略部長 署名：____________________ ### 乙 株式会社データアステル データサイエンス部 署名：____________________ ## 14. 特約事項（追加対応の扱い） 追加対応は時間単価ベースで別途見積または追加発注として扱う。 <!-- block_index=122 type=paragraph
